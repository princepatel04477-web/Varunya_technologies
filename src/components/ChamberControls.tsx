  ...
  return (
    <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-6 md:p-12 z-40 select-none">
      ...
      <div className="flex justify-between items-center w-full pointer-events-auto">
        ...
        <button
          onClick={onExit}
          className="flex items-center gap-3 group focus:outline-none -my-8"
        ...
        >
          <Image
            ...
            width={112}
            height={112}
            className="h-16 w-16 sm:h-28 sm:w-28 object-contain group-hover:scale-105 transition-transform duration-300 invert"
            priority
          />
          <span className="hidden sm:inline-block h-[1px] w-6 bg-[#d4af37]/35" />
          <span className="hidden sm:inline-block text-[10px] tracking-widest text-[#d4af37] font-semibold uppercase">
            {t.exhibition}
          </span>
        </button>
